...
class _AnalyticsScreenState extends State<AnalyticsScreen> with SingleTickerProviderStateMixin {
      ...
      children: [
        ...
        if (_selectedExerciseId != null)
          Expanded(
            child: Padding(
              padding: const EdgeInsets.all(16.0),
              child: _buildPerformanceChart(workoutProvider, _selectedExerciseId!),
            ),
          ),
      ],
    );
      ...
      LineChartData(
        ...
        titlesData: FlTitlesData(
          ...
          bottomTitles: SideTitles(
            ...
            reservedSize: 22,
            getTitles: (value) {
              // Show date for specific indices
  ...
  List<PieChartSectionData> _getMuscleGroupSections(Map<String, int> muscleGroups) {
